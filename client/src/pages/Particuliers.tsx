...
<div className="flex flex-col items-center gap-4 relative">
  ...
  <video
    className="rounded-xl shadow-lg w-full max-w-[340px] md:max-w-[380px] h-[520px] object-contain bg-[#947f61]"
    src="/videos/reel.mp4"
    controls
    playsInline
    preload="metadata"
...
<div className="mb-10 flex justify-center">
  ...
  <span className="text-2xl text-gray-400 font-medium line-through decoration-red-500 decoration-2">
    85 €
        ...
        target="_blank"
          className="bg-[#947f61] text-white px-6 py-3 rounded-lg w-full block text-center mb-24"
        >

      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            ...
            <Link to="/particuliers" className="text-gray-700 hover:text-amber-700 transition font-bold">Particuliers</Link>
            ...
            <div className="grid md:grid-cols-4 gap-8">
              {[
                ...
                <div key={i} className="p-6 border border-gray-200 rounded-lg hover:shadow-lg transition">
                  ...
                  <p className="text-3xl font-bold text-amber-700 mb-4">{plan.price}</p>
                  <p className="text-gray-700 mb-6">{plan.desc}</p>
                  <button className="w-full bg-amber-700 text-white py-2 rounded hover:bg-amber-800 transition font-semibold">
                    Réserver
                  </button>
                </div>
              ))}

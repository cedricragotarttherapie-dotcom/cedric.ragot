      ...
      <header className="border-b border-gray-200 bg-white sticky top-0 z-50">
        <div className="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
          ...
          <nav className="flex items-center gap-8">
            ...
            <Link to="/particuliers" className="text-gray-700 hover:text-blue-600 transition">Particuliers</Link>
            ...
            <a href="https://www.instagram.com/cedric_ragot" target="_blank" rel="noopener noreferrer" className="text-gray-700 hover:text-blue-600 transition">
              <Instagram size={20} />
            </a>
          </nav>
        </div>
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-blue-50 to-indigo-50 py-20">
          <div className="max-w-6xl mx-auto px-4">
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-5xl font-bold text-gray-900 mb-6">Trouvez la Paix Intérieure</h2>
                <p className="text-xl text-gray-700 mb-8">Découvrez les bienfaits transformateurs de la sonothérapie et du massage sonore aux bols tibétains</p>
                <div className="flex gap-4">
                  <Link to="/particuliers" className="bg-blue-600 text-white px-8 py-3 rounded-lg hover:bg-blue-700 transition font-semibold">
                    En savoir plus
                  </Link>
                  <Link to="/faq" className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-lg hover:bg-blue-50 transition font-semibold">
        ...
        <section className="py-20 bg-blue-600 text-white">
          <div className="max-w-2xl mx-auto px-4">
            <h3 className="text-3xl font-bold mb-6 text-center">Recevez nos conseils et actualités</h3>
            <form className="flex gap-2">
              <input
                ...
                required
              />
              <button type="submit" className="bg-white text-blue-600 px-8 py-3 rounded font-semibold hover:bg-gray-100 transition">
                S'inscrire
              </button>
            </form>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li className="flex items-center gap-2"><Mail size={16} /> contact@cedricragot.com</li>
                <li className="flex items-center gap-2"><MapPin size={16} /> Localisation</li>
              </ul>
            </div>
            <div>
              <h5 className="font-bold text-white mb-4">Suivez-nous</h5>
              <a href="https://www.instagram.com/cedric_ragot" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-white transition">
